-- ctrl + T atajo para generar un nuevo archivo SQL para generar consultas
-- Ejemplos con sakila
USE sakila;
SHOW tables;
DESCRIBE city;
...
-- SELECCIONAR LA TABLA Y OBSERVAR LOS CAMBIOS
SELECT * FROM KOI;
...
-- MOSTRAR LISTADO DE TABLAS Y COMPROBAR LOS CAMBIOS REALIZADOS
SHOW tables;

########################TRUNCAR TABLAS

-- COMO BORRAMOS LA TABLA, LA VOLVEMOS A CREAR
USE sakila;
CREATE TABLE KOI
SELECT city_id, phone, district, location FROM address;
...
-- CON ESTE COMANDO TRUNCAMOS LA TABLA
TRUNCATE TABLE KOI;

-- COMPROBAMOS LOS CAMBIOS
SELECT * FROM KOI

#########################################################   CÓMO AGREGAR Y QUITAR PRIMARY KEY A UNA TABLA
-- CREAR UN GRUPO
CREATE DATABASE grupos;
USE grupos;

-- CREAR UNA TABLA CON LOS CAMPOS Y EL TIPO DE CADA UNO
CREATE TABLE ZONAS (
ID INT NOT NULL,
...
-- LLAMAR LA TABLA CON EL COMANDO DESCRIBIR
DESC ZONAS;

-- ASIGNAR LA PRIMARY KEY DENTRO DE LA TABLA, VA A SER EL CAMPO ID
ALTER TABLE ZONAS
ADD PRIMARY KEY (ID);
...
-- ESTE ES EL PASO PARA ELIMINAR LA PRIMARY KEY
ALTER TABLE ZONAS
DROP PRIMARY KEY;
...
-- ELIMINAR EL GRUPO O BASE DE DATOS
DROP DATABASE grupos;


#////////////////////////////////////////////   FORMA 2 DE CREAR Y ASIGNAR  UNA PRIMARY KEY
...
-- creamos una tabla y dentro del código asignamos el campo ID como PRIMARY KEY
CREATE TABLE ZONAS (
ID INT NOT NULL,
DIR_COD INT NOT NULL,
DIR VARCHAR(20),
...
#////////////////////////////////////////////////////// CÓMO AGREGAR Y QUITAR UNA FOREIGN KEY

-- llamamos las tablas ZONAS y GRUPO_1
DESC ZONAS;
DESC GRUPO_1;

-- con el siguiente código, se va a asignar dentro de la tabla GRUPO_1 la FOREIGN KEY
-- al campo DIR_COD usando como referencia el campo ID de la tabla ZONAS
ALTER TABLE GRUPO_1
...
-- creamos una nueva tabla, donde se puede apreciar la creacion de la PRIMARY KEY en el campo ID, 
-- así como la FOREIGN KEY en el campo DIR_COD usando como referencias el campo ID de la tabla ZONAS
...
-- llamamos la tabla y vemos los resultados
DESC GRUPO_2;

-- con el siguiente codigo, rmeovemos la FOREIGN KEY
ALTER TABLE GRUPO_1
DROP FOREIGN KEY FK_ZONASID;

#/////////////////////////////////////////////  AGREGAR Y QUITAR UNIQUE CONSTRAINT 

-- llamamos la tabla
DESC GRUPO_1;

-- agregamos una CONSTRAINT (restricción) a la tabla GRUPO_1 al campo NOMBRE
ALTER TABLE GRUPO_1
ADD CONSTRAINT u_nombre UNIQUE (NOMBRE);

-- llamamos la tabla y se comprueban los cambios dentro de la tabla
DESC GRUPO_1;

-- creamos una nueva tabla, dentro de la cual asignamos la PRIMARY KEY en el campo ID, 
-- y asignando una UNIQUE CONSTRAINT al campo DIR_ID
...
-- para desasignar la UNIQUE CONSTRAINT usamos el comando DROP INDEX
ALTER TABLE GRUPO_1
DROP INDEX U_NOMBRE;
...
# ///////////////////////////////////////// CAMBIAR EL DATA TYPE (TIPO DE DATOS) DE UNA COLUMNA
...
-- Seleccionamos la tabla para poder editar lo atributos de esta
SELECT * FROM PRODUCTOS;

-- Con el siguiente código, se ingresa información a la tabla en edición
INSERT INTO PRODUCTOS (NOMBRE, PRECIO, PROVEEDOR)
VALUES
	("CAFE", 3.99, "LUCKY_LUCAS_CA");

-- Seleccionamos la tabla y vemos sus atributos
SELECT * FROM PRODUCTOS;

-- Nuevamente ingresamos información con las líneas siguientes
INSERT INTO PRODUCTOS (NOMBRE, PRECIO, PROVEEDOR)
VALUES
...
WHERE ID = 1;          #*******************POR DEFAULT SOLO PODEMOS USAR LA COLUMNA ID COMO CONDICIÓN PORQUE ES LA PRIMARY KEY***********

SELECT * FROM PRODUCTOS;

#****** ACTUALIZAR MÁS DE UNA COLUMNA A LA VEZ

SET SQL_SAFE_UPDATES = 0;      #****************ESTO CAMBIA LA CONFIGURACIÓN PARA UTILIZAR OTROS CAMPOS COMO CONDICIÓN*******
...
UPDATE PRODUCTOS
SET PROVEEDOR = "MOLTISANTI_CA"
WHERE PROVEEDOR = "LUCKY_LUCAS_CA";

SELECT * FROM PRODUCTOS;

#//////////////////////// CÓMO BORRAR DATOS EN UNA TABLA
...
INSERT INTO EMPLEADOS (APELLIDO, NOMBRE, EDAD)
VALUES
	("Borgia", "Juan", 15)    #****** Este ejemplo no procede porque el rango de edad está por debajo de lo que se puso como CONSTRAINT
...
#*****Se van a crear cada una de las tablas que van a dar lugar a todo el esquema de trabajo mostrado en el curso
